...
.ascii "->VCPU_GUEST_CTXT #264 offsetof(struct kvm_vcpu, arch.ctxt)"	@
@ 0 "" 2
@ 177 "arch/arm/kernel/asm-offsets.c" 1
	
.ascii "->VCPU_HOST_CTXT #856 offsetof(struct kvm_vcpu, arch.host_cpu_context)"	@
@ 0 "" 2
@ 178 "arch/arm/kernel/asm-offsets.c" 1
	
.ascii "->CPU_CTXT_VFP #152 offsetof(struct kvm_cpu_context, vfp)"	@
@ 0 "" 2
@ 179 "arch/arm/kernel/asm-offsets.c" 1
	
.ascii "->CPU_CTXT_GP_REGS #0 offsetof(struct kvm_cpu_context, gp_regs)"	@
@ 0 "" 2
@ 180 "arch/arm/kernel/asm-offsets.c" 1
	
.ascii "->GP_REGS_USR #0 offsetof(struct kvm_regs, usr_regs)"	@
@ 0 "" 2
