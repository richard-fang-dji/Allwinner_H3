...
#define VCPU_GUEST_CTXT 264 /* offsetof(struct kvm_vcpu, arch.ctxt) */
#define VCPU_HOST_CTXT 856 /* offsetof(struct kvm_vcpu, arch.host_cpu_context) */
#define CPU_CTXT_VFP 152 /* offsetof(struct kvm_cpu_context, vfp) */
#define CPU_CTXT_GP_REGS 0 /* offsetof(struct kvm_cpu_context, gp_regs) */
#define GP_REGS_USR 0 /* offsetof(struct kvm_regs, usr_regs) */
